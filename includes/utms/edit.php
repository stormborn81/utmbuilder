                ...
                <div class="col-xl-12">
                      ...
                      <div class="row justify-content-between align-items-center">
                         <div class="col-md-6 d-flex align-items-center justify-content-between justify-content-md-start mb-3 mb-md-0">
                            ...
                            <div class="d-inline-block">
                              <h5 class="h4 d-inline-block font-weight-400 mb-0 text-white">Edit URL with UTM</h5>
                            </div>
                   ...
                   <div class="card">
                      ...
                      <div class="card-body">
                           ...
                           <h6> <br />Update the UTM again below if required</h6>
                      </div>
                   </div>
                   <?php } ?>
                      ...
                      <div class="card">
                         <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control <?php echo (!empty($url_err)) ? 'is-invalid' : ''; ?>" id="input-url" name="url"  value="<?php echo (!empty($_POST["url"])) ? trim($_POST["url"]) : $uBase; ?>" placeholder="Enter your URL i.e. http://www.spaceman.com/page?star=vega">
